...
public class PracticeNotificationService extends Service {
    ...
    private void sendNotification() {
        List<com.example.guitartrainalocal.services.Notification> notifications =    getPrevNotifications();
        ...
        notifications.add(0, new com.example.guitartrainalocal.services.Notification(
    ...
    private List<com.example.guitartrainalocal.services.Notification> getPrevNotifications() {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
        String serializedList = sharedPreferences.getString("notifications", null);
        if(serializedList != null){
            Gson gson = new Gson();
            return gson.fromJson(serializedList, new TypeToken<List<com.example.guitartrainalocal.services.Notification>>(){}.getType());
        }
        else{
